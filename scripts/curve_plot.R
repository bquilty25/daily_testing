...
curve_plot_a <- trajectories_to_plot %>% 
  ...
  scale_color_viridis_b(name="Probability of positive culture (infectiousness)",option = "magma",begin=0.2,end=0.8,guide=guide_colorsteps(show.limits = T,barwidth=12),label=label_percent())+
...
ggsave("curve_plot_twit.png",width=297,height=150,units="mm",dpi=600,bg = "white")
